...
export default function PickAdd({step, setStep, monthly}:ComponentsProps){
    ...
    return(
        <section className="select-plan">
            ...
            <div className="pick-hero-cnt">
                <PickHero schedule={monthly?'+$1/mo':'+$10/yr'} title="Online service" description="Accsess to multiplayer games" />
                <PickHero schedule={monthly?'+$2/mo':'+$20/yr'}  title="Larger storage" description="Extra 1TB of cloud save" />
                <PickHero schedule={monthly?'+$2/mo':'+$20/yr'}  title="Customizable profile" description="Custom theme on your profile" />
            </div>
